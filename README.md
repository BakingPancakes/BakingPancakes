...
A graduate from UMass Amherst with a B.S. in Computer science, a former intern at both [CRICO](https://www.rmf.harvard.edu/) and [Volta Labs](https://www.voltalabs.com/), and an avid follower of the advances within wearable health monitoring, lab automation robotics, and data science for healthcare. My goal going forward is to apply my skillset where I can make the best impact alongside people who are just as passionate as me!

Pursing an M.S. in CS at UMass Amherst with exp. grad. May 2027.

-------------------

# What have I accomplished?
## Projects
### ([Link](https://github.com/Fukiburi/compsci528)) Gesture recognition to control a drone mid-flight
> ESP32, C/C++, Python, Scikit-learn, ESP-IDF
...
Created self-hosted website developed to share articles from an Apache HTTP server using MEVN
stack while simulating git best practices and sprint-based development

## Education
 - B.S. in Computer Science, UMass CICS class of '26
 - Pursuing M.S. in Computer Science 2026-2027

---

# What do I excel at?
### Languages:
 - Python, Javascript/Typescript, C/C++, SQL, Java, R, Html/CSS

### Web Frameworks:
 - (frontend) Vue, React, NextJS, Vite, TailwindCSS
 - (backend) ExpressJS, NodeJS, PostgreSQL, ApacheHTTP Server

### Machine Learning frameworks and libraries
 - Scikit-learn, joblib, streamlit, Numpy, Pandas, matplotlib, Pytorch, Deep Graph Library (DGL)

### Python Packages
 - Pandas, Numpy, Asyncio, Pydantic, Matplotlib, pyserial

### Tools
 - Jupyter Notebook, R Studio, LaTeX, ESP-IDF, VS-code, Linux systemd library, GNU standard library



Some default github readme.md stuff that I might use later:
